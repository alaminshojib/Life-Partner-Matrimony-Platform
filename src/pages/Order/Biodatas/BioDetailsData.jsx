...
const BioDetailsData = ({ singleData }) => {
  const rows = [
    ...
    { name: 'Permanent Division :', value: singleData?.permanent_division },
    ...
    <div>
      <div className="container flex flex-col w-fit h-fit max-w-lg mx-auto divide-y rounded-md border-2 divide-gray-700 bg-white text-black">
        ...
        <div className="p-4 space-y-2 text-sm text-gray-400">
          ...
          <Link to="/contact" className="btn btn-sm btn-outline hover:bg-red-800 border-0 border-b-2 mx-auto justify-center items-center text-center px-2 w-fit flex text-white bg-red-500 m-4">
