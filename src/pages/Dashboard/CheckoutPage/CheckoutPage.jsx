...
const CheckoutPage = () => {
  ...
  const [checkouts, refetch, isLoading, isError] = useCheckouts(); // Destructure isLoading and isError
      ...
      <div className="flex justify-between mb-8">
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className={`btn bg-blue-500 text-white px-6 py-2 rounded-md ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'
              }`}
